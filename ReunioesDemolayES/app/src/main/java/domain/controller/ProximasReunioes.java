...
public class ProximasReunioes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_proximas_reunioes);
        ...
        ProximasReunioes.Task task = new ProximasReunioes.Task();
        task.execute();
    ...
    public class Task extends AsyncTask<String, String, Void> {
        ...
        private ProgressDialog progressDialog = new ProgressDialog(ProximasReunioes.this);
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialog) {
                    ProximasReunioes.Task.this.cancel(true);
                }
            });
        };
        ...
        protected Void doInBackground(String... params) {
            ...
            String url = ipServidor.getIpServidor()+"/proximasReunioes.php";
            ...
            try {
                ...
                Toast.makeText(ProximasReunioes.this, "Tente novamente.", Toast.LENGTH_LONG).show();
            }
        ...
        protected void onPostExecute(Void v){
            ...
            try {
                ...
                for (int i = 0; i < Jarray.length(); i++) {
                    ...
                    aux = "• " + nomeCapitulo + " nº " + numeroCapitulo + "\n" + "Dia: " + data + " - " + hora + " - " + descricao +
                            " - Grau " + grau;

                    param.add(aux);

                    textViewNome.setText("Descubra onde e quando acontecerão as próximas reuniões no estado!");

                    ArrayAdapter<String> ad = new ArrayAdapter<String>(ProximasReunioes.this, android.R.layout.simple_list_item_1, param);
